...
interactive_plot <- girafe_options(
  ...
  opts_hover_inv(css = "opacity: 0.2;"),  # Higher opacity for non-hovered lines
...
team_stats_encoded <- team_stats |>x dummy_cols(select_columns = "Team", remove_first_dummy = TRUE, remove_selected_columns = FALSE)
