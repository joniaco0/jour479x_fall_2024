...
```
Trout has only been on a team with over 90 Team Wins once, and has only been to the playoffs once. Despite this, he's turned in 
Some of the best seasons of all time, which carry his WARSHARE numbers. To really see how impressive his numbers are, there have been around 30 players in the past 20 years that have over a 10% WARSHARE. Aaron Judge and Bobby Witt Jr. are the only players to do it in more than one season. Mike Trout has done it six times.
```{r}
