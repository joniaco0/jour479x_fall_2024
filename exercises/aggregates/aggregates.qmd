...
This dataset is rate data for all players with at lease one minute played
...
**Answer** DESCRIBE THE RESULTS HERE
The results show that shooting guards are the most common position in the league followed by centers. Shooting guards is what the league caters to the most. 
...
The combinations of the positions adds a problem to the set, I would have whichever they play most to assign them to that position.
...
**ANSWER** 
Centers are the second most common position, right behind shooting guards, yet they are the second lowest of the main positions in total. The position is pretty intresting considering the status of the league in paying and producting centers